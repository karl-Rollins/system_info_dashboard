...
Some developers might not know how to check their device's infomations. The script lays down what they need in a presentable manner.
...
Open the folder system_info_dashboard in your IDE(eg vscode)
All code is written in the syinfo.sh file.
